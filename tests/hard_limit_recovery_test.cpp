...
int main() {
  ...
  runtime.io().write_serial_command("G0 X100 F120\n");
  ...
  const auto hard_limit_output = runtime.io().read_serial_text();
  ...
  const auto m999_output = runtime.io().read_serial_text();
