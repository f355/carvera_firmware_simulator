...
class GetEepromContents(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class SetEepromContents(_message.Message):
    __slots__ = ("contents",)
    CONTENTS_FIELD_NUMBER: _ClassVar[int]
    contents: EepromContents
    def __init__(self, contents: _Optional[_Union[EepromContents, _Mapping]] = ...) -> None: ...

class EepromContents(_message.Message):
    __slots__ = ("tool_length_offset", "reference_machine_z", "tool_machine_z", "reserved", "active_tool", "tool_not_calibrated", "current_wcs", "persistent_variables", "work_coordinate_systems")
    TOOL_LENGTH_OFFSET_FIELD_NUMBER: _ClassVar[int]
    REFERENCE_MACHINE_Z_FIELD_NUMBER: _ClassVar[int]
    TOOL_MACHINE_Z_FIELD_NUMBER: _ClassVar[int]
    RESERVED_FIELD_NUMBER: _ClassVar[int]
    ACTIVE_TOOL_FIELD_NUMBER: _ClassVar[int]
    TOOL_NOT_CALIBRATED_FIELD_NUMBER: _ClassVar[int]
    CURRENT_WCS_FIELD_NUMBER: _ClassVar[int]
    PERSISTENT_VARIABLES_FIELD_NUMBER: _ClassVar[int]
    WORK_COORDINATE_SYSTEMS_FIELD_NUMBER: _ClassVar[int]
    ...
    current_wcs: int
    persistent_variables: _containers.RepeatedCompositeFieldContainer[PersistentVariable]
    work_coordinate_systems: _containers.RepeatedCompositeFieldContainer[WorkCoordinateSystem]
    def __init__(self, tool_length_offset: _Optional[float] = ..., reference_machine_z: _Optional[float] = ..., tool_machine_z: _Optional[float] = ..., reserved: _Optional[float] = ..., active_tool: _Optional[int] = ..., tool_not_calibrated: _Optional[bool] = ..., current_wcs: _Optional[int] = ..., persistent_variables: _Optional[_Iterable[_Union[PersistentVariable, _Mapping]]] = ..., work_coordinate_systems: _Optional[_Iterable[_Union[WorkCoordinateSystem, _Mapping]]] = ...) -> None: ...

class PersistentVariable(_message.Message):
    __slots__ = ("number", "value")
    NUMBER_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    number: int
    value: float
    def __init__(self, number: _Optional[int] = ..., value: _Optional[float] = ...) -> None: ...

class WorkCoordinateSystem(_message.Message):
    __slots__ = ("number", "x", "y", "z", "a", "rotation")
    NUMBER_FIELD_NUMBER: _ClassVar[int]
    ...
    a: float
    rotation: float
    def __init__(self, number: _Optional[int] = ..., x: _Optional[float] = ..., y: _Optional[float] = ..., z: _Optional[float] = ..., a: _Optional[float] = ..., rotation: _Optional[float] = ...) -> None: ...
